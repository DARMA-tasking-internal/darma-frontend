...
template parameter).  \todo{Wording here - I can't quite grasp meaning of this. This allows for the development of archive types that, for
...
\todo{How do we serialize primitive types? And why can't a struct by default use same mechanism?}
...
\todo{Mention this in spec evolution section}
