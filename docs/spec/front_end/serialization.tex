...
as DARMA sees it.  TODO finish this
...
builtin and standard library types, including containers, POD types, and arrays
of serializable types.  TODO more complete list
...
by the DARMA serialization interface.
