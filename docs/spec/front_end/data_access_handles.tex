...
When a handle is created with \inlinecode{initial_acces} or \inlinecode{read_acces},
it is implicitly given immediate permissions of None.
When a handle is used inside a task instantiated in the application with \inlinecode{create_work},
