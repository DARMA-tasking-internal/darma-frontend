...
\end{CppCode}
\todo[inline]{Jeremy/David: I updated the last line in the example above to be 
  "continuing context in parent task" rather than "continuing task in parent
task". please revert if this is an error. ow just delete the todo.}
