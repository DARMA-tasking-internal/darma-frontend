...
passed to the \codelink{create_work} construct (as well as other deferred constructs which
...
is communicated to the \gls{runtime system} via \codelink{create_work} function, which utilizes
...
\codelink{AccessHandle<T>} (the return type of \codelink{initial_access})
