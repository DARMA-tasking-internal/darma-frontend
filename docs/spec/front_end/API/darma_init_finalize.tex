...
\codetarget{darma_init} initializes the DARMA execution environment for a \gls{rank}.
...
\paragraph{Summary}\mbox{}\\
\codetarget{darma_finalize} the DARMA execution environment for a \gls{rank}.
