...
Note that the \todo{Jeremy/David: should the following be the 
translation layer will process and remove...} back end will process and remove 
...
\gls{DARMA} \gls{rank}.  At least by the time this function {\em returns}, the \todo{Jeremy/David: again,
should the followign be the translation layer guarantees...} back end guarantees that all work
(\glspl{task}) created between the corresponding \codelink{darma_init} call and this
