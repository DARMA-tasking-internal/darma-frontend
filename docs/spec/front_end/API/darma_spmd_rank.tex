...
a rank's \gls{execution stream}\todo{make sure this use of execution stream is
  correct here, was changed from opaque context}, regardless of whether that work gets stolen or
migrated.
