...
\todo{check if this list is complete}
    \end{compactenum}
...
add missing things}
\todo[inline]{When is modification of fetched data going to be possible?}
\todo[inline]{When is support for functors with templated call operators planned?}
\todo[inline]{When is deserialization into polymorphic base class pointers going to be supported?}
\todo[inline]{When is support for generalized ranks planned?}
...
\begin{compactdesc}
\item[0.3.1:]
\todo{is this the right version number?}
\begin{compactitem}
