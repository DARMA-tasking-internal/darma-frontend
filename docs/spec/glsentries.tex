...
\newglossaryentry{EDSL}
{
  ...
  name={EDSL},
  plural={EDSLs},
  first={embedded domain specific language (E\gls{DSL})},
...
\newglossaryentry{middleware}
{
  type=glossary,
    name = middleware,
    description={See \gls{middle end}}
} 
\newglossaryentry{middle end}
{
  type=glossary,
  name = {middle end},
  description = {The \CC \gls{template metaprogramming} layer between the
    DHARMA \gls{front end} and the set of abstract classes that must be implemented
...
\newglossaryentry{DHARMA} 
{
  type=glossary,
  name={DHARMA},
  description={ The DHARMA (Distributed asyncHronous Adaptive and Resilient Models for
