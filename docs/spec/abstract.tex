...
\CC compiler that supports the \CC11 standard with a small subset of \CC14 required for advanced features (\inlinecode{gcc >= 4.8, clang >=
3.5}).  The \gls{translation layer} leverages \CC\ \gls{template
