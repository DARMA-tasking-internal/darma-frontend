...
\inlinecode{darma_runtime::abstract::frontend} and
\inlinecode{darma_runtime::abstract::backend}.  The former contains
...
\section{Abstract classes in {\tt darma\_runtime::abstract::backend}}
