...
This document captures version \specVersion\ of the specification, in which we 
specify several key features of the DARMA programming model. The features
described in \specVersion\ are not comprehensive, meaning they do not capture all of the
