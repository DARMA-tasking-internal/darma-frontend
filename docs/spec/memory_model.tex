...
In addition to facilitating coordination between \glspl{rank}, \gls{handle} data structures 
...
\glspl{task}. 
The \gls{DARMA} scheduler \todo{Jeremy/David: It seems to me like this sentence
  should read "DARMA's translation layer enforces", since the runtime is makes
    dynamic scheduling decisions that preserve data flow obtained by sequential
    semantics.  }  enforces the \CC{} sequential consistency model at
