...
we plan for the \gls{API} to also express \todo{Janine: add gls link once
  Jeremy has updated glossary to include task elasticity} task elasticity in future versions.
